...
Define_Module(MMSAppServer);

simsignal_t MMSAppServer::rcvdPkSignal = SIMSIGNAL_NULL;
simsignal_t MMSAppServer::sentPkSignal = SIMSIGNAL_NULL;

void MMSAppServer::initialize()
{
...
void MMSAppServer::handleMessage(cMessage *msg)
{
...
void MMSAppServer::sendOrSchedule(cMessage *msg, simtime_t delay)
{
    if (delay==0)
        sendBack(msg);
    else
...
void MMSAppServer::sendBack(cMessage *msg)
{
    GenericAppMsg *appmsg = dynamic_cast<GenericAppMsg*>(msg);
