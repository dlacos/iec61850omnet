...
#ifndef _SAMPLEDVALUE_M_H_
#define _SAMPLEDVALUE_M_H_
...
/**
 * Class generated from <tt>nodes/iec61850/ied/applicationProfile/sampledValues/sampledValue.msg</tt> by opp_msgc.
 * <pre>
 * packet SampledValue {
 * 	int appid;
 *     int length;
 ...
 * </pre>
 */
class SampledValue : public ::cPacket
{
  protected:
    int appid_var;
    int length_var;
  ...
  private:
    void copy(const SampledValue& other);

  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const SampledValue&);

  public:
    SampledValue(const char *name=NULL, int kind=0);
    SampledValue(const SampledValue& other);
    virtual ~SampledValue();
    SampledValue& operator=(const SampledValue& other);
    virtual SampledValue *dup() const {return new SampledValue(*this);}
...
inline void doPacking(cCommBuffer *b, SampledValue& obj) {obj.parsimPack(b);}
inline void doUnpacking(cCommBuffer *b, SampledValue& obj) {obj.parsimUnpack(b);}


#endif // _SAMPLEDVALUE_M_H_
